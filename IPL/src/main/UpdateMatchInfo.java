...
public class UpdateMatchInfo extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					UpdateMatchInfo frame = new UpdateMatchInfo();
	...
	public UpdateMatchInfo() {
		...
		label.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				UpdateMatchInfo.this.setState(JFrame.ICONIFIED);
			}
			@Override
		...
		JLabel lblNewLabel = new JLabel(" Update Match Information");
		lblNewLabel.addMouseMotionListener(new MouseMotionAdapter() {
			@Override
			public void mouseDragged(MouseEvent e) {
				int x = e.getXOnScreen();
				int y = e.getYOnScreen();
				UpdateMatchInfo.this.setLocation(x - xx, y - yy);
			}
		});
		...
		table.setModel(new DefaultTableModel(
			...
			new String[] {
				"ID", "VENUE", "DATE", "TEAM1", "TEAM2", "WINNER", "METHOD", "PLAYER_OF_MATCH"
			}
		) {
		...
		lblNewLabel_2.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				try {
					...
					st2.executeUpdate("update matchinfo set VENUE = '"+textField_2.getText()+"', MATCH_DATE = '"+textField_3.getText()+"', TEAM_F = '"+textField_4.getText()+
					"', TEAM_S = '"+textField_5.getText()+"', WINNER = '"+textField_6.getText()+"', METHOD = '"+textField_1.getText()+"', PLAYER_OF_MATCH  = '"+textField_7.getText()+"' where ID = "+textField.getText());
					con2.close();
					st2.close();
				}
				catch (Exception ab) {
		...
		lblNewLabel_2.setBounds(775, 565, 100, 40);
		...
		lblClear.setBackground(new Color(255, 215, 0));
		lblClear.setBounds(710, 640, 100, 40);
		...
		lblSave.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				try {
					...
					st3.executeUpdate("insert into matchinfo values ("+textField.getText()+",'"+textField_2.getText()+"','"+textField_3.getText()
		...
		lblSave.setBackground(new Color(255, 215, 0));
		lblSave.setBounds(660, 565, 100, 40);
		...
		lblDelete.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				try {
					...
					st4.executeUpdate("delete from matchinfo where ID = "+textField.getText());
					con4.close();
					st4.close();
				}
				catch (Exception ab) {
		...
		lblDelete.setBackground(new Color(255, 215, 0));
		lblDelete.setBounds(890, 565, 100, 40);
		...
		lblMatch.setFont(new Font("Century Gothic", Font.BOLD, 20));
		lblMatch.setBounds(660, 500, 100, 28);
	...
	public void retrive() {
		...
		table.addColumn("TEAM1");
		table.addColumn("TEAM2");
		table.addColumn("WINNER");
		table.addColumn("METHOD");
		table.addColumn("PLAYER_OF_MATCH");
		try{
			Connection conn = DataBaseConnection.makeConnection();
			Statement st = conn.createStatement();
			ResultSet rs = st.executeQuery("select * from matchinfo order by id");
			while(rs.next()) {
