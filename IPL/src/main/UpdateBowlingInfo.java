...
public class UpdateBowlingInfo extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					UpdateBowlingInfo frame = new UpdateBowlingInfo();
	...
	public UpdateBowlingInfo() {
		...
		label.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				UpdateBowlingInfo.this.setState(JFrame.ICONIFIED);
			}
			@Override
		...
		JLabel lblNewLabel = new JLabel(" Update Bowling Information");
		lblNewLabel.addMouseMotionListener(new MouseMotionAdapter() {
			@Override
			public void mouseDragged(MouseEvent e) {
				int x = e.getXOnScreen();
				int y = e.getYOnScreen();
				UpdateBowlingInfo.this.setLocation(x - xx, y - yy);
			}
		});
		...
		table.setModel(new DefaultTableModel(
			...
			new String[] {
				"ID", "NAME", "MATCH", "BALL", "RUNS", "WICKET", "ECONOMY", "5W"
			}
		) {
			Class[] columnTypes = new Class[] {
					Integer.class, Object.class, Integer.class, Integer.class, Integer.class, Integer.class, Object.class, Integer.class
			};
		...
		lblNewLabel_2.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				try {
					...
					st2.executeUpdate("update bowlinginfo set NAME = '"+textField_2.getText()+"', MATCH = "+textField_3.getText()+", BALL = "+textField_4.getText()+
					", RUNS = "+textField_5.getText()+", WICKET = "+textField_6.getText()+", ECONOMY = '"+textField_1.getText()+"', FIVE_WICKET  = "+textField_7.getText()+" where ID = "+textField.getText());
					con2.close();
					st2.close();
				}
				catch (Exception ab) {
		...
		lblSave.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				try {
					...
					st3.executeUpdate("insert into bowlinginfo values ("+textField.getText()+",'"+textField_2.getText()+"',"+textField_3.getText()
		...
		lblDelete.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				try {
					...
					st4.executeUpdate("delete from bowlinginfo where ID = "+textField.getText());
					con4.close();
					st4.close();
				}
				catch (Exception ab) {
	...
	public void retrive() {
		...
		try{
			...
			ResultSet rs = st.executeQuery("select * from bowlinginfo order by id");
			while(rs.next()) {
