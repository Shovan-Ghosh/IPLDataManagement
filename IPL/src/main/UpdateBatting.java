...
public class UpdateBatting extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					UpdateBatting frame = new UpdateBatting();
	...
	public UpdateBatting() {
		...
		label.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				UpdateBatting.this.setState(JFrame.ICONIFIED);
			}
			@Override
		...
		JLabel lblNewLabel = new JLabel(" Update Batting");
		lblNewLabel.addMouseMotionListener(new MouseMotionAdapter() {
			@Override
			public void mouseDragged(MouseEvent e) {
				int x = e.getXOnScreen();
				int y = e.getYOnScreen();
				UpdateBatting.this.setLocation(x - xx, y - yy);
			}
		});
		...
		table.setModel(new DefaultTableModel(
			...
			new String[] {
				"NO", "NAME", "RUN", "BALL", "4s", "6s", "S / R"
			}
		) {
			Class[] columnTypes = new Class[] {
					Integer.class, Object.class, Integer.class, Integer.class, Integer.class, Integer.class, Integer.class
			};
		...
		textField.setBounds(666, 60, 228, 34);
		...
		lblBall.setBounds(574, 210, 80, 28);
		...
		textField_2.setBounds(666, 135, 228, 34);
		...
		textField_3.setBounds(666, 210, 228, 34);
		...
		textField_4.setBounds(666, 285, 228, 34);
		...
		textField_5.setBounds(666, 360, 228, 34);
		...
		textField_6.setBounds(666, 435, 228, 34);
		...
		lblNewLabel_2.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				try {
					...
					st2.executeUpdate("update updatebatting set run = "+textField_2.getText()+", ball = "+textField_3.getText()+", fours = "+textField_4.getText()+
					", sixs = "+textField_5.getText()+", s_r = "+textField_6.getText()+" where no = "+textField.getText());
					con2.close();
					st2.close();
				}
				catch (Exception ab) {
	...
	public void retrive() {
		...
		try{
			...
			ResultSet rs = st.executeQuery("select * from updatebatting order by no");
			while(rs.next()) {
